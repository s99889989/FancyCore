...
public class GuiButtom {
    ...
    public static ItemStack valueOf(Player player, FileConfiguration itemConfig, String itemID, String key, String reKey){
        ...
        //設定物品顯示名稱
        if(itemConfig.contains(itemID+".DisplayName")){
            GuiButtomSet.setDisplayName(player, null, itemConfig, itemID, newItemStack, key, reKey);
        }
        //設定物品Lore
        if(itemConfig.contains(itemID+".Lore")){
            GuiButtomSet.setLore(player, null, itemConfig, itemID, newItemStack, key, reKey);
