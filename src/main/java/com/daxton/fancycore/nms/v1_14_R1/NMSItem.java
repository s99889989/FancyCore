package com.daxton.fancycore.nms.v1_14_R1;
...
public class NMSItem {
	...
	public static ItemStack jsonStringToItemStack(@NotNull String itemString){
		try {
			net.minecraft.server.v1_14_R1.NBTTagCompound compound = MojangsonParser.parse(itemString);
			net.minecraft.server.v1_14_R1.ItemStack nmsItemStack = net.minecraft.server.v1_14_R1.ItemStack.a(compound);
			return org.bukkit.craftbukkit.v1_14_R1.inventory.CraftItemStack.asBukkitCopy(nmsItemStack);
	...
	public static ItemStack[] base64toItemStack(String itemString) {
		...
		for(int i = 0; i < nbtTagList.size(); ++i) {
			...
			if (!nbtTagCompound.isEmpty()) {
				itemStacks[i] = CraftItemStack.asCraftMirror(net.minecraft.server.v1_14_R1.ItemStack.a(nbtTagCompound));
			}
		}
